        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10 contactForm">
                ...
                <div>
                    ...
                    // Day of the month:
                        // d (01/31) -> two digits with leAading zeros 
                        // j (1 /31) -> without leeading zeros
                    // Day of the week:
                        // D (Mon/Sun)-> text as an abbrevation
                        // l (monday) -> full lowercase
                        // L (MONDAY) -> full uppercase
                    // Month:
                        // m (01/12) -> two digits with leading zeros
                        // M (Jan) -> text as an abbrevation
                        // F (January) -> Full month
                    // Year:
                        // y (09/15) -> two digits
                        // Y (2009-2019) -> Four Digits
                    ...
                    // hour:
                        // h (01-12)->12hour format with leading zeros
                    ...
                    <?php
                        ...
                        $timestamp = mktime(15, 20, 12, 5, 10,2021);
                        echo "<p>Timestamp is : $timestamp</p>";
                        $time = date("F d, Y h:i:s A", $timestamp);
                    ...
                    <?php
                        $timestamp = mktime(0,0,0,28,2,1987);
                        echo "<p>Timestamp is : $timestamp</p>";
